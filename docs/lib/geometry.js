...
export function canthalTilt(inner, outer, aspect) {
 ...
 */
export function headPose(points, aspect) {
 ...
 */
export function faceBoxFromPoints(points) {
    ...
    if (!Number.isFinite(x0) || x1 - x0 < 1e-3 || y1 - y0 < 1e-3)
        return null;
